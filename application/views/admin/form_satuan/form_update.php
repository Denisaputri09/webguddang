        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <!-- <li><a href="<?= base_url('admin/form_satuan') ?>"><i class="fa fa-circle-o"></i> Tambah PIC</a></li> -->
            </ul>
          </li>
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/tabel_satuan') ?>"><i class="fa fa-circle-o"></i> Data PIC</a></li>
            </ul>
          </li>
          <li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Update Data PIC</li>
        </ol>
      </section>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Data PIC</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                      ...
                      <div class="form-group">
                        <?php foreach ($data_satuan as $d) { ?>
                          ...
                          <div class="box-footer" style="width:93%;">
                            ...
                            <button type="submit" style="width:13%" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Update </button>
                          </div>
                  </form>
                </div>
              </div>
