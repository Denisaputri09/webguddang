...
<head>
  ...
  <title>Web Kegiatan Diklat | Data Kegiatan Selesai</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?= base_url('admin/tabel_barangmasuk') ?>">Data Kegiatan</a></li>
          <li class="active">Data Kegiatan Selesai</li>
        </ol>
      </section>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Kegiatan Selesai</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <?php foreach ($list_data as $d) { ?>
                          ...
                          <input type="text" name="id_transaksi" style="margin-left:69px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?= $d->id_transaksi ?>">
                      </div>
                      <div class="form-group">
                        <label for="tanggal" style="margin-left:220px;display:inline;">Tanggal Mulai</label>
                        <input type="text" name="tanggal" style="margin-left:54px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?= $d->tanggal ?>">
                      </div>
                      <div class="form-group">
                        <label for="tanggal_keluar" style="margin-left:220px;display:inline;">Tanggal Terlaksana</label>
                      ...
                      <div class="form-group" style="margin-bottom:40px;">
                        <label for="lokasi" style="margin-left:220px;display:inline;">PIC</label>
                        <input type="text" name="lokasi" style="margin-left:119px;width:20%;display:inline;" class="form-control" value="<?= $d->lokasi ?>">
                      </div>
                      ...
                      <div class="form-group" style="display:inline-block;">
                        <label for="satuan" style="width:73%;">Status</label>
