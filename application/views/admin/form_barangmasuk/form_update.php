  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url('admin/form_barangmasuk') ?>"><i class="fa fa-circle-o"></i> Tambah Data Kegiatan Masuk</a></li>
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="<?= base_url('admin/tabel_barangmasuk') ?>"><i class="fa fa-circle-o"></i> Data Kegiatan Masuk</a></li>
              <li><a href="<?= base_url('admin/tabel_barangkeluar') ?>"><i class="fa fa-circle-o"></i> Data Kegiatan Selesai</a></li>
              <li><a href="<?= base_url('admin/tabel_satuan') ?>"><i class="fa fa-circle-o"></i> Data Status Kegiatan</a></li>
            </ul>
          </li>
          <li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Update Data Kegiatan Masuk
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="#">Forms</a></li>
          <li class="active">Update Data Kegiatan Masuk</li>
        </ol>
      </section>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Data Kegiatan Masuk</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_databarang_masuk_update') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="tanggal" style="margin-left:23px;width:20%;display:inline;" class="form-control" value="<?= $d->tanggal ?>">
                      </div>
                      <div class="form-group">
                        <label for="tanggal_selesai" style="margin-left:220px;display:inline;">Tanggal Selesai</label>
                        <input type="text" name="tanggal_selesai" style="margin-left:13px;width:20%;display:inline;" class="form-control" value="<?= $d->tanggal_selesai ?>">
                      </div>
                      ...
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_Barang" style="width:73%;">Absensi Peserta</label>
                        <input type="text" name="nama_barang" required style="width:80%;margin-right: 67px;" class="form-control" id="nama_Barang" value="<?= $d->nama_barang ?>">
                      </div>
