  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?= base_url('admin') ?>" class="logo">
        ...
        <span class="logo-mini"><b>PT</b>Pindad</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>PT Pindad</b></span>
      </a>
      ...
      <section class="sidebar">
        ...
        <li class="treeview">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('admin/form_barangmasuk') ?>"><i class="fa fa-circle-o"></i> Tambah Data Kegiatan Masuk</a></li>
              <li><a href="<?php echo base_url('admin/form_satuan') ?>"><i class="fa fa-circle-o"></i> Tambah Data PIC</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
