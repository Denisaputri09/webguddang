...
class Admin extends CI_Controller
{
  ...
  public function proses_databarang_masuk_insert()
  {
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      $this->session->set_flashdata('msg_berhasil', 'Data Kegiatan Berhasil Ditambahkan');
  ...
  public function proses_databarang_masuk_update()
  {
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      $this->session->set_flashdata('msg_berhasil', 'Data Kegiatan Berhasil Diupdate');
      redirect(base_url('admin/tabel_barangmasuk'));
    } else {
  ...
  public function proses_satuan_insert()
  {
    ...
    if ($this->form_validation->run() ==  TRUE) {
      ...
      $this->session->set_flashdata('msg_berhasil', 'Data PIC Berhasil Ditambahkan');
  ...
  public function proses_satuan_update()
  {
    ...
    if ($this->form_validation->run() ==  TRUE) {
      ...
      $this->session->set_flashdata('msg_berhasil', 'Data PIC Berhasil Di Update');
      redirect(base_url('admin/tabel_satuan'));
    } else {
